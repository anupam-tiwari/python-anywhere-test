...
def uploaded_chest():
  ...
  # vgg_pred = vgg_chest.predict(image)
   ...
   #,vgg_chest_pred=vgg_chest_pred,inception_chest_pred=inception_chest_pred,xception_chest_pred=xception_chest_pred)
...
def uploaded_ct():
   ...
   resnet_ct = load_model('models/res.h5')
